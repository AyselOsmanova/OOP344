...
// Declared minWidth as static
template<typename L, typename V>
size_t SummableLVPair<L, V>::minWidth{ 0u };

// Explicit specialization of LVList<std::string, std::string>
template<> std::string SummableLVPair<std::string, std::string>::initialValue = "";
// Explicit specialization of LVList<std::string, int>
template<> int SummableLVPair<std::string, int>::initialValue = 0;
